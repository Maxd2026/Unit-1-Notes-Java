...
public class Main {
   ...
   public static void main(String []args) {
      ...
      // Casting is helpful when dividing intergers
      int apcs = 13;
      int juniors = 40;
      ...
      // ROUNDING by casting
      double positiveNum = 41.69;
      double negetiveNum = -67.42;
      int nearestPositive = (int) (positiveNum + 0.5);
      int nearestNegetive = (int) (negetiveNum - 0.5);
      System.out.println(nearestPositive);
      System.out.println(nearestNegetive);
